...
class SettingsPopup(Popup):
    ...
    def __init__(self, settings_store: DataToolsSettingsStore, **kwargs):
        ...
        # Map: settings key -> value preview label widget.
        ...
        create_row(
            "CSV delimiter",
            "csv_delimiter",
            values.get("csv_delimiter", ","),
            "Edit",
            lambda *_: self._open_text_edit("CSV delimiter", "csv_delimiter"),
        )
        create_row(
            "Decimal separator",
            "decimal_separator",
            values.get("decimal_separator", "."),
            "Edit",
            lambda *_: self._open_text_edit("Decimal separator", "decimal_separator"),
        )
        ...
        create_row(
            ...
            "default_export_folder",
            values.get("default_export_folder", ""),
            "Browse",
            lambda *_: self._browse_folder("default_export_folder"),
        )
        create_row(
            "Matching DB path",
            "matching_db_path",
        ...
        # DataTools DB path is generated by app architecture and shown as read-only.
        create_row(
            "DataTools DB path",
            "datatools_db_path",
            values.get("datatools_db_path", ""),
            "View",
            lambda *_: None,
        )
