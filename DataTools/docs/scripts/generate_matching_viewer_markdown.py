...
def _build_markdown(title: str, image_paths: list[Path]) -> str:
    ...
    lines.append("## Generator Info")
    lines.append("")
    lines.append("This manual is auto-generated by docs/scripts/generate_matching_viewer_markdown.py.")
    lines.append("")
...
def main() -> None:
    ...
    output = generate(title=args.title)
